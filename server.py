...
def generate_text():
    try:
        ...
        prompt = (
            ...
            "Bitte acht Zeilen für einen Liebesbrief oder zwei Strophen zu je vier Versen für ein Liebesgedicht. Gedichte können sich reimen, müssen aber nicht. Briefe dürfen sich nicht reimen. Bitte alle Texte ohne Titel."
        )
